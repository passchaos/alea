...
const examples = [_]Example{
    ...
    .{ .path = "examples/reproducible_streams.zig", .step = "zig build run-reproducible-streams", .source_tokens = &.{ "engine raw aliases", "nextU64", "nextU32", "fillBytes", "engine seedFromU64 alias", "engine fromSeed alias" } },
