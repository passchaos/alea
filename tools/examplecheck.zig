...
const examples = [_]Example{
    ...
    .{
        ...
        .source_tokens = &.{ "one-shot weighted u32 index", "weighted index batch", "weighted u32 index batch", "weighted value batch", "generic weighted value batch", "weighted const ptr batch", "weighted mut ptr batch", "generic weighted index", "generic weighted index batch", "generic weighted u32 index", "generic weighted u32 index batch", "weighted choice sample u32 index", "weighted choice u32 indices", "WeightedChoice.indicesU32From", "WeightedChoice.valuesFrom", "WeightedChoice.ptrsFrom", "weighted ptrs into", "weighted no-replacement ptrs", "weighted u32 no-replacement indices", "weighted IndexVec", "weighted u32 index array", "weighted u32 indices into" },
    },
    .{
