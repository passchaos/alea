...
const examples = [_]Example{
    .{
        ...
        .source_tokens = &.{ "bytesAlloc", "valueBatch u16", "chanceBatch p=.25", "ratioBatch 3/8", "vectorChanceBatch boolx8", "vectorRatioBatch boolx8", "normalBatch", "exponentialBatch", "vectorNormalBatch f64x4", "vectorExponentialBatch f64x4", "sampleBatch dice", "index choice", "u32 index choice", "const pointer choice" },
    },
