...
const examples = [_]Example{
    ...
    .{
        ...
        .source_tokens = &.{ "custom charset get(0)", "custom charset probability(0)", "custom charset probabilityIter fill", "unicode scalar fill", "unicode scalar batch", "unicode scalar range fill", "unicode scalar range batch", "unicodeScalarBatch", "fillUnicodeScalar", "unicodeScalarRangeAtMostBatchChecked", "fillUnicodeScalarRangeLessThanChecked" },
    },
