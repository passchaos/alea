...
const examples = [_]Example{
    ...
    .{
        ...
        .source_tokens = &.{ "generic weighted index", "weighted ptrs into", "weighted no-replacement ptrs", "weighted IndexVec", "weighted u32 index array", "weighted u32 indices into" },
    },
    .{
