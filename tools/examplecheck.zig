...
const examples = [_]Example{
    .{
        ...
        .source_tokens = &.{ "bytesAlloc", "nextU64 raw", "nextU32 raw", "fillBytes raw", "rngReader bytes", "StepRng bytes", "constRng next", "randomValue u16", "root sampler helpers", "sampleDie=", "sampleFill=", "root choice helpers", "choiceIndex=", "choiceIndexU32=", "indexFill=", "indexFillU32=", "indexArray=", "indexArrayU32=", "valueArray=", "choiceBatch=", "root repeated choice array helpers", "values=", "constPtrs=", "mutPtrs=", "root pointer choice helpers", "ptrArray=", "ptrBatch=", "root mutable pointer choice helpers", "root shuffle helpers", "shuffle=", "partial=", "tailPartial=", "root no-replacement helpers", "sampleArray=", "chooseArray=", "samplePtrArray=", "samplePtrs=", "sampleMutPtrArray=", "sampleMutPtrs=", "sampleItemsInto=", "samplePtrsInto=", "sampleMutPtrsInto=", "root chooseMultiple aliases", "chooseMultiple=", "chooseMultiplePtrs=", "chooseMultipleMutPtrs=", "chooseMultipleInto=", "chooseMultiplePtrsInto=", "chooseMultipleMutPtrsInto=", "root sampled iterator helpers", "sampleItemsIter=", "samplePtrsIter=", "sampleMutPtrsIter=", "root reservoir helpers", "reservoirSample=", "reservoirPtrs=", "reservoirMutPtrs=", "reservoirInto=", "reservoirPtrsInto=", "reservoirMutPtrsInto=", "indices=", "indexVec=", "indexArray=", "indexArrayU32=", "indicesInto=", "indicesU32=", "weightedIndices=", "weightedIndexVec=", "weightedIndexArray=", "weightedIndexArrayU32=", "weightedIndicesInto=", "weightedIndicesU32Into=", "weightedValuesInto=", "weightedArray=", "weightedPtrs=", "weightedPtrsInto=", "weightedMutPtrs=", "weightedMutPtrsInto=", "root weighted by no-replacement helpers", "byIndexIndices={any}", "byIndexIndicesInto={any}", "byIndexIndicesU32={any}", "byIndexIndicesU32Into={any}", "byIndexVecIndices={any}", "byIndexArrayIndices={any}", "byIndexArrayIndicesU32={any}", "byIndices={any}", "byIndicesInto={any}", "byIndicesU32={any}", "byIndexVec={any}", "byIndexArray={any}", "byIndexArrayU32={any}", "byValueArray=[{s}, {s}]", "byPtrArray=[{s}, {s}]", "byMutPtrArray=[{s}, {s}]", "bySample=[{s}, {s}]", "byInto=[{s}, {s}]", "byPtrInto=[{s}, {s}]", "byPtrSample=[{s}, {s}]", "byMutPtrInto=[{s}, {s}]", "byMutPtrSample=[{s}, {s}]", "root iterator helpers", "weightedChoice=", "sample=", "sampleInto=", "sampleFill=", "sampleArray=", "weightedSample=", "weightedInto=", "weightedArray=", "root weighted helpers", "weightedIndex=", "weightedIndexU32=", "byIndex=", "by=", "byLabel={s}", "byU32=", "byIndexU32=", "fillBy=", "fillU32By=", "batchBy=", "batchU32By=", "arrayBy=", "arrayU32By=", "fillByIndex=", "fillU32ByIndex=", "batchByIndex=", "batchU32ByIndex=", "arrayByIndex=", "arrayU32ByIndex=", "fillU32=", "array=", "arrayU32=", "batchU32=", "root weighted value helpers", "root weighted value repeated helpers", "byArray=[{s}, {s}, {s}, {s}]", "byValue={s}", "byFill=[{?s}, {?s}, {?s}, {?s}]", "byBatch=[{?s}, {?s}, {?s}, {?s}]", "byIndexValue=", "byIndexFill=", "byIndexBatch=", "byIndexArray=", "root weighted pointer helpers: ptr={s}, byPtr={s}, byPtrFill=[{s}, {s}, {s}, {s}], byPtrBatch=[{?s}, {?s}, {?s}, {?s}], byPtrArray=[{s}, {s}, {s}, {s}], byIndexPtr={s}, byIndexFill=[{s}, {s}, {s}, {s}], byIndexBatch=", "byIndexArray=", "ptrArray=", "root weighted mutable pointer helpers: ptr={s}, byPtr={s}, byPtrFill=[{s}, {s}, {s}, {s}], byPtrBatch=[{?s}, {?s}, {?s}, {?s}], byPtrArray=[{s}, {s}, {s}, {s}], byIndexPtr={s}, byIndexFill=[{s}, {s}, {s}, {s}], byIndexBatch=", "byIndexArray=", "root random helpers", "rangeFill", "inclusiveFill", "boolFill", "ratioFill", "valueBatch=", "rangeBatch=", "boolBatch=", "ratioBatch=", "root endpoint float helpers", "openFill=", "openBatch=", "openClosedFill=", "openClosedBatch=", "root duration helpers", "lessThan=", "atMost=", "lessThanBatch=", "atMostBatch=", "root string helpers", "sampleString=", "appendString=", "unicodeScalar=", "unicodeScalarFill=", "unicodeScalarBatch=", "unicodeInto=", "unicodeAlloc=", "valueBatch u16", "uintLessThanBatch u16", "uintAtMostBatch u16", "randomBool p=.25", "randomRatio 3/8", "chanceBatch p=.25", "ratioBatch 3/8", "vectorChanceBatch boolx8", "vectorRatioBatch boolx8", "standardNormalBatch", "standardExponentialBatch", "normalBatch", "exponentialBatch", "vectorStandardNormalBatch f64x4", "vectorStandardExponentialBatch f64x4", "vectorNormalBatch f64x4", "vectorExponentialBatch f64x4", "sample die", "sampleBatch dice", "sampleIter sizeHint", "index choice", "u32 index choice", "index choice array", "u32 index choice array", "index choice batch", "u32 index choice batch", "value choice array", "value choice batch", "const pointer choice", "const pointer choice array", "const pointer choice batch", "mutable pointer choice array", "mutable pointer choice batch" },
    },
