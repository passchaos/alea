...
const examples = [_]Example{
    ...
    .{
        ...
        .source_tokens = &.{ "IndexVec.valuesInto", "IndexVec.valuesOwned", "IndexVec.ptrsOwned", "IndexVec.mutPtrsOwned", "IndexVec.toOwnedU32Slice", "Choice.sampleIndexFrom", "Choice.valuesFrom", "Choice.ptrsFrom", "Choice.indicesU32From", "Choice.fillIndicesU32From", "chooseIteratorStableFrom", "sampleIteratorFillFrom", "sampleArrayU32", "sampleItemsFrom", "sampleItemsIntoFrom", "sampleItemsArrayFrom", "samplePtrArrayFrom", "sampleMutPtrArrayFrom", "shuffleFrom", "chooseMultiplePtrs", "reservoirSamplePtrsInto" },
    },
    .{
