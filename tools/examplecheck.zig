...
const examples = [_]Example{
    ...
    .{
        ...
        .source_tokens = &.{ "one-shot weighted u32 index", "weighted index batch", "weighted u32 index batch", "weighted value batch", "generic weighted value batch", "weighted const ptr batch", "generic weighted const ptr batch", "weighted mut ptr batch", "generic weighted mut ptr batch", "weighted by value", "weighted by const ptr", "weighted by mut ptr", "weighted by no-replacement sample", "weighted by no-replacement ptrs", "weighted by no-replacement mut ptr", "weighted by no-replacement indices", "weighted by u32 no-replacement indices", "weighted by IndexVec", "weighted by indices into", "weighted by values into", "weighted by ptrs into", "weighted by mut ptrs into", "generic weighted index", "generic weighted index batch", "generic weighted u32 index", "generic weighted u32 index batch", "weighted choice sample u32 index", "weighted choice u32 indices", "WeightedChoice.indicesU32From", "WeightedChoice.valuesFrom", "WeightedChoice.ptrsFrom", "weighted ptrs into", "weighted no-replacement ptrs", "weighted u32 no-replacement indices", "weighted IndexVec", "weighted u32 index array", "weighted u32 indices into" },
    },
    .{
