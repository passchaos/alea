...
pub fn main(init: std.process.Init) !void {
    ...
    try stdout.print("root iterator helpers: choice={}, weightedChoice={}, sample={any}, sampleInto={any}, sampleArray={any}, weightedSample={any}\n", .{ root_iterator_choice, root_weighted_iterator_choice, root_iterator_sample, root_iterator_sample_into, root_iterator_sample_array, root_weighted_iterator_sample });
