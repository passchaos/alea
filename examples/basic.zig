...
pub fn main(init: std.process.Init) !void {
    ...
    try stdout.print("root no-replacement helpers: sample={any}, indices={any}, indicesInto={any}, indicesU32={any}, weightedIndices={any}, weightedIndicesInto={any}, weightedIndicesU32Into={any}, weightedValues=[{s}, {s}], weightedValuesInto=[{s}, {s}], weightedArray=[{s}, {s}], weightedPtrs=[{s}, {s}], weightedPtrsInto=[{s}, {s}], weightedMutPtrs=[{s}, {s}], weightedMutPtrsInto=[{s}, {s}]\n", .{ root_no_replacement, root_sample_indices, root_sample_indices_into, root_sample_indices_u32, root_sample_weighted_indices, root_sample_weighted_indices_into, root_sample_weighted_indices_u32_into, root_sample_weighted_values[0], root_sample_weighted_values[1], root_sample_weighted_values_into[0], root_sample_weighted_values_into[1], root_sample_weighted_value_array[0], root_sample_weighted_value_array[1], root_sample_weighted_ptrs[0].*, root_sample_weighted_ptrs[1].*, root_sample_weighted_ptrs_into[0].*, root_sample_weighted_ptrs_into[1].*, root_sample_weighted_mut_ptrs[0].*, root_sample_weighted_mut_ptrs[1].*, root_sample_weighted_mut_ptrs_into[0].*, root_sample_weighted_mut_ptrs_into[1].* });
