...
pub fn main(init: std.process.Init) !void {
    ...
    try stdout.print("root no-replacement helpers: sample={any}, sampleArray={any}, samplePtrArray=[{}, {}, {}], samplePtrs=[{}, {}, {}], sampleMutPtrArray=[{}, {}, {}], sampleMutPtrs=[{}, {}, {}], indices={any}, indexVec={any}, indexArray={any}, indexArrayU32={any}, indicesInto={any}, indicesU32={any}\n", .{ root_no_replacement, root_no_replacement_array, root_no_replacement_ptr_array[0].*, root_no_replacement_ptr_array[1].*, root_no_replacement_ptr_array[2].*, root_no_replacement_ptrs[0].*, root_no_replacement_ptrs[1].*, root_no_replacement_ptrs[2].*, root_no_replacement_mut_ptr_array[0].*, root_no_replacement_mut_ptr_array[1].*, root_no_replacement_mut_ptr_array[2].*, root_no_replacement_mut_ptrs[0].*, root_no_replacement_mut_ptrs[1].*, root_no_replacement_mut_ptrs[2].*, root_sample_indices, root_sample_index_vec_values, root_sample_index_array, root_sample_index_array_u32, root_sample_indices_into, root_sample_indices_u32 });
