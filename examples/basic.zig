...
pub fn main(init: std.process.Init) !void {
    ...
    try stdout.print("root iterator helpers: choice={}, weightedChoice={}, sample={any}, sampleInto={any}\n", .{ root_iterator_choice, root_weighted_iterator_choice, root_iterator_sample, root_iterator_sample_into });
