...
- reusable uniform, Bernoulli, non-uniform distribution, opt-in bounded f32
  LogNormal approximation, and alias-table samplers with single-weight updateAt, numChoices, positiveCount, compact `u32` index
