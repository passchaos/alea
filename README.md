...
- collection helpers for `choose`, `shuffle`, fixed-size item arrays, caller-owned item subsets, partial shuffle selected/rest splits, compact `IndexVec` index samples with lazy/caller-owned value and pointer mapping, weighted indexes,
