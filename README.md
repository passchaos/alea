...
- reusable sampler `map` adapters for Rust-discoverable `Distribution::map`
  ...
  `UniformUsize`, `UniformError`, and one-shot `sampleSingle` / `sampleSingleInclusive` aliases,
