...
- bulk `fillSample`, `fillRange`, strict-interval scalar and vector float
  fill, distribution-namespace vector Bernoulli/uniform/strict-interval/normal/exponential
...
distribution-namespace vector Bernoulli/uniform/normal/exponential wrappers,
