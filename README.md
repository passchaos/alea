...
- bulk `fillSample`, `fillRange`, strict-interval scalar and vector float
  fill, distribution-namespace vector Bernoulli/binomial/Poisson/uniform/strict-interval/normal/exponential
...
distribution-namespace vector Bernoulli/binomial/Poisson/uniform/normal/exponential wrappers,
