...
- reusable uniform with Rust-discoverable `new` / `newInclusive` aliases, Bernoulli with Rust-discoverable `new` / `fromRatio` aliases, non-uniform distribution, opt-in bounded f32
