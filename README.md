...
- reusable uniform with Rust-discoverable `new` / `newInclusive` aliases, Bernoulli with Rust-discoverable `new` / `fromRatio` / `p()` aliases, non-uniform distribution, opt-in bounded f32
