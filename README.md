...
- ASCII `Alphanumeric`, `Alphabetic`, custom `Charset`, direct-source charset
  helpers, checked charset methods plus optional item, probability, and probability-iterator diagnostics for fallible custom charsets, and Unicode
