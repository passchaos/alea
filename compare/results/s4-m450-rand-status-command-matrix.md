...
After S4-M1225 improved ordinary f64 uniform low-bit/vector8 throughput, the
...
and report that the S4-M11 runtime branch and S4-M1124/S4-M1127-S4-M1225 follow-ups
are closed for the current bar while S4-M1226 is the next post-S4-M1225 product bar. This is tooling validation evidence
