...
After S4-M1237 aligned direct-source byte-helper fallback, the
...
and report that the S4-M11 runtime branch and S4-M1124/S4-M1127-S4-M1237 follow-ups
are closed for the current bar while S4-M1238 is the next post-S4-M1237 product bar. This is tooling validation evidence
