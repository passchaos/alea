...
After S4-M1180 added typed static weighted diagnostics, the lightweight `rand-status` command matrix
...
are closed for the current bar while S4-M1181 is the next post-S4-M1180 product bar. This is tooling validation evidence
