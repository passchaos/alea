...
After S4-M1236 aligned direct-source native-u64 fallback, the
...
and report that the S4-M11 runtime branch and S4-M1124/S4-M1127-S4-M1236 follow-ups
are closed for the current bar while S4-M1237 is the next post-S4-M1236 product bar. This is tooling validation evidence
