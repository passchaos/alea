...
After S4-M1163 aligned AliasTable per-weight maximum validation with local
`rand_distr::WeightedAliasIndex`, the lightweight `rand-status` command matrix
...
and report that the S4-M11 runtime branch and S4-M1124/S4-M1127-S4-M1163 follow-ups
are closed for the current bar while S4-M1164 is the next post-S4-M1163 product bar. This is tooling validation evidence
