...
After S4-M1172 added weighted iterator clone/format helpers, the lightweight `rand-status` command matrix
...
are closed for the current bar while S4-M1173 is the next post-S4-M1172 product bar. This is tooling validation evidence
