...
After S4-M1168 added weighted sampler format helpers, the lightweight `rand-status` command matrix
...
are closed for the current bar while S4-M1169 is the next post-S4-M1168 product bar. This is tooling validation evidence
