...
After S4-M1234 hardened root string preallocation, the
...
are closed for the current bar while S4-M1235 is the next post-S4-M1234 product bar. This is tooling validation evidence
