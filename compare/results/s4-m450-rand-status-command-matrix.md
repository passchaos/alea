...
After S4-M1241 aligned nextU32-only source fallback, the
...
and report that the S4-M11 runtime branch and S4-M1124/S4-M1127-S4-M1241 follow-ups
are closed for the current bar while S4-M1242 is the next post-S4-M1241 product bar. This is tooling validation evidence
