...
After S4-M1173 refreshed validate-all evidence, the lightweight `rand-status` command matrix
...
are closed for the current bar while S4-M1174 is the next post-S4-M1173 product bar. This is tooling validation evidence
