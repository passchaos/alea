...
After S4-M1232 hardened owned byte allocation fallbacks, the
...
are closed for the current bar while S4-M1233 is the next post-S4-M1232 product bar. This is tooling validation evidence
