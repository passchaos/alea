...
After S4-M1235 aligned fallible direct-source raw-u32 fallback, the
...
are closed for the current bar while S4-M1236 is the next post-S4-M1235 product bar. This is tooling validation evidence
