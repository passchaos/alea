...
index/u32-index batches, S4-M151 adds `sampleIndex` / `fillIndices` dynamic tree aliases, and S4-M152 adds repeated dynamic tree index/u32-index iterators, but later stages should
