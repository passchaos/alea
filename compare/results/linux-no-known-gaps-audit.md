...
a central examples catalog, S4-M29 adds catalog drift checking, and S4-M30 adds
build/tooling catalog drift checking, but later stages should keep raising the
