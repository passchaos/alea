...
allocation-returning accessor-weighted index/u32-index/IndexVec samples, and
S4-M119 adds accessor-weighted fixed-size index arrays, but later stages should
