...
| weighted index and weighted item choice | Covered | `Rng.weightedIndex`, `seq.chooseWeighted`, `seq.chooseWeightedPtr`, `seq.sampleWeightedIndicesInto`, `seq.sampleWeightedInto`, `seq.sampleWeightedIndexArray`, `seq.sampleWeightedArray`, `seq.sampleWeightedPtrArray`, `AliasTable`, `WeightedTree`, benchmark rows |
...
sampling, and S4-M54 adds fixed-size weighted pointer array sampling, but later
