...
u32 index slices, S4-M73 adds fixed-size u32 index arrays, and S4-M74 adds
IndexVec u32 export mapping, but later stages should keep raising the bar rather
