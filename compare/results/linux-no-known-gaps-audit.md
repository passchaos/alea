...
`seq.fillChooseIndex` / `seq.chooseIndexBatch` aliases, and S4-M135 adds
accessor-weighted `seq.fillChooseWeighted*By` aliases, but later stages should
