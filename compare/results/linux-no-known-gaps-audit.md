...
adds index-weighted no-replacement samples, and S4-M126 adds caller-owned
index-weighted buffers, but later stages should keep raising the bar rather
