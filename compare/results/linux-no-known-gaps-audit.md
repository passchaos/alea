...
and S4-M115 adds accessor-based weighted value/const-pointer/mutable-pointer
choices for item-embedded weights, but later stages should keep raising the bar
