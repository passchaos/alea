...
| WeightedAliasIndex | `AliasTable(Weight)` | unit tests, benchmark rows for weighted index paths; f64 `WeightedAliasIndex` row is exceeded by `AliasTable(f64)`, while u32 remains a small S4-M4 throughput watch |
