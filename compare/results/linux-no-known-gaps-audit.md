...
adds caller-owned accessor-weighted no-replacement buffers, and S4-M118 adds
allocation-returning accessor-weighted index/u32-index/IndexVec samples, but
