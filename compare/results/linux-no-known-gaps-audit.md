...
(`compare/results/s4-m1226-float-fill-lane-store-refactor.md`) by deriving vectorized fill widths from the vector type and centralizing lane copies while covering packed f32 and f64 strict-open stream shapes. S4-M1227 refactors distribution lane stores (`compare/results/s4-m1227-distribution-lane-store-refactor.md`) by applying shared vector load/store helpers to staged distribution transforms. S4-M1228 remains active for
