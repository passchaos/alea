...
sample-fill aliases, S4-M124 adds slice item/pointer sample aliases, and
S4-M125 adds index-weighted no-replacement samples, but later stages should keep
