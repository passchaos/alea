...
| --- | --- | --- |
| integer, float, bool, range, owned scalar/vector range, strict-interval, probability, and duration batches, ratio/chance, caller-owned and allocation-returning bytes | Covered | `Rng`, `Rng.rangeBatch`, `Rng.vectorRangeBatch`, `Rng.openBatch`, `Rng.openClosedBatch`, `Rng.chanceBatch`, `Rng.ratioBatch`, `Rng.bytesAlloc`, unit tests, Zig/Rust benchmark rows |
...
bool batches, and S4-M90 adds Rng owned normal/exponential batches, S4-M91 adds Rng owned duration range batches, and S4-M92 adds Rng owned vector
range batches, but later stages should keep raising the bar rather than
