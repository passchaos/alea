...
adds f64 weighted u32 index choice, S4-M79 adds WeightedChoice index fills, and
S4-M80 adds Choice index fills, but later stages should keep raising the bar
