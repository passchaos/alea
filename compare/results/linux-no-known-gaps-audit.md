...
LogNormal, and native-f32 opt-in profiles, and S4-M15 puts those examples under
local validation, but later stages should keep raising the bar rather than
