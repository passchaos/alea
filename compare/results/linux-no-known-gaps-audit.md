...
| --- | --- | --- |
| integer, float, bool, range, owned range batches, ratio/chance, caller-owned and allocation-returning bytes | Covered | `Rng`, `Rng.rangeBatch`, `Rng.bytesAlloc`, unit tests, Zig/Rust benchmark rows |
...
byte buffers, and S4-M87 adds Rng owned scalar range batches, but later stages
