...
S4-M1192 refreshed status output after repairing rand-status post-bar drift.
...
while the post-S4-M1192 S4-M1193 bar continues to block whole-goal completion.
