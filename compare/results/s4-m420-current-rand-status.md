...
S4-M1174 refreshed status output after updating `latest_validate_local_evidence` in
`rand-status-json` to the weighted error message evidence. The passing
...
while the post-S4-M1174 S4-M1175 bar continues to block whole-goal completion.
