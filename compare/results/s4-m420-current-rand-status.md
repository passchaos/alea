...
S4-M1194 refreshed status output after adding weighted namespace aliases.
...
$ zig build rand-status-json
  "schema_version": 1,
  "current_conclusion": "S4-M11 runtime branch plus S4-M1124/S4-M1127-S4-M1194 follow-ups closed for current bar",
  "remaining_blocker": "S4-M1195 post-S4-M1194 next product bar",
...
while the post-S4-M1194 S4-M1195 bar continues to block whole-goal completion.
