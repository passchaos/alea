...
S4-M1171 refreshed status output after updating `latest_validate_local_evidence` in
`rand-status-json` to the post-S4-M1170 validate-all evidence. The passing
...
1/121 distributions.test.weighted samplers clone and equality mirror local Rust derives...OK
...
All 121 tests passed.

$ zig build rand-status-json
  "schema_version": 1,
  "current_conclusion": "S4-M11 runtime branch plus S4-M1124/S4-M1127-S4-M1171 follow-ups closed for current bar",
  "remaining_blocker": "S4-M1172 post-S4-M1171 next product bar",
...
while the post-S4-M1171 S4-M1172 bar continues to block whole-goal completion.
