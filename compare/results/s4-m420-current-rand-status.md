...
S4-M1200 refreshed status output after running the full `validate-all` aggregate following the ziggurat-table surface guard update.
...
$ zig build rand-status-json
  "schema_version": 1,
  "current_conclusion": "S4-M11 runtime branch plus S4-M1124/S4-M1127-S4-M1200 follow-ups closed for current bar",
  "remaining_blocker": "S4-M1201 post-S4-M1200 next product bar",
...
while the post-S4-M1200 S4-M1201 bar continues to block whole-goal completion.
