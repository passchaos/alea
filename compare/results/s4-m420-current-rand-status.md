...
S4-M1186 refreshed status output after the post-S4-M1185 `validate-local`
aggregate passed. The passing local comparison run and retained dense SIMD
evidence include:
...
while the post-S4-M1186 S4-M1187 bar continues to block whole-goal completion.
