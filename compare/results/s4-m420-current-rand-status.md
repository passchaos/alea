...
S4-M1181 refreshed status output after the post-S4-M1180 `validate-all`
aggregate passed. The passing run and retained local Rust comparison evidence
include:
...
rand_distr standard-normal: 37.7 M samples/s checksum=-3.640
rand_distr standard-normal f32: 34.0 M samples/s checksum=-3.640
...
while the post-S4-M1181 S4-M1182 bar continues to block whole-goal completion.
