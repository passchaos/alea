...
S4-M1198 refreshed status output after running the full `validate-all` aggregate following the Poisson max-lambda public constants change.
...
$ zig build rand-status-json
  "schema_version": 1,
  "current_conclusion": "S4-M11 runtime branch plus S4-M1124/S4-M1127-S4-M1198 follow-ups closed for current bar",
  "remaining_blocker": "S4-M1199 post-S4-M1198 next product bar",
...
while the post-S4-M1198 S4-M1199 bar continues to block whole-goal completion.
