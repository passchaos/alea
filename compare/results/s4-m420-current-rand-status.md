...
S4-M1180 refreshed status output after updating `latest_validate_local_evidence` in
`rand-status-json` to the typed static weighted diagnostics evidence. The passing
...
while the post-S4-M1180 S4-M1181 bar continues to block whole-goal completion.
