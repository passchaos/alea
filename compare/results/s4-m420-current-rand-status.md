...
S4-M1193 refreshed status output after the post-S4-M1192 `validate-local` aggregate.
...
$ zig build rand-status-json
  "schema_version": 1,
  "current_conclusion": "S4-M11 runtime branch plus S4-M1124/S4-M1127-S4-M1193 follow-ups closed for current bar",
  "remaining_blocker": "S4-M1194 post-S4-M1193 next product bar",
...
while the post-S4-M1193 S4-M1194 bar continues to block whole-goal completion.
