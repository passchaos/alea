...
S4-M1177 refreshed status output after updating `latest_validate_local_evidence` in
`rand-status-json` to the post-S4-M1176 validate-all evidence. The passing
...
$ zig build rand-status-json
  "schema_version": 1,
  "current_conclusion": "S4-M11 runtime branch plus S4-M1124/S4-M1127-S4-M1177 follow-ups closed for current bar",
  "remaining_blocker": "S4-M1178 post-S4-M1177 next product bar",
  ...
  "latest_validate_local_evidence": "compare/results/s4-m1177-post-s4-m1176-validate-all.md"
...
while the post-S4-M1177 S4-M1178 bar continues to block whole-goal completion.
