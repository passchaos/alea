...
S4-M1173 refreshed status output after updating `latest_validate_local_evidence` in
`rand-status-json` to the post-S4-M1172 validate-all evidence. The passing
...
while the post-S4-M1173 S4-M1174 bar continues to block whole-goal completion.
