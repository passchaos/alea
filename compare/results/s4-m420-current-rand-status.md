...
S4-M1196 refreshed status output after updating the local rand weighted manifest.
...
$ zig build rand-status-json
  "schema_version": 1,
  "current_conclusion": "S4-M11 runtime branch plus S4-M1124/S4-M1127-S4-M1196 follow-ups closed for current bar",
  "remaining_blocker": "S4-M1197 post-S4-M1196 next product bar",
...
while the post-S4-M1196 S4-M1197 bar continues to block whole-goal completion.
