...
S4-M1182 refreshed status output after the weighted public-surface manifest
refresh. The current manifest/status validation and retained broad validation evidence
include:
...
while the post-S4-M1182 S4-M1183 bar continues to block whole-goal completion.
