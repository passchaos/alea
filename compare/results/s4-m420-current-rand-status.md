...
S4-M1191 refreshed status output after repairing rand-status post-bar drift.
...
while the post-S4-M1191 S4-M1192 bar continues to block whole-goal completion.
