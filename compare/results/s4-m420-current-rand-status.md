...
S4-M1183 refreshed status output after adding `seq.WeightedChoice` typed
weighted diagnostics. The focused API validation and retained broad validation
evidence include:
...
while the post-S4-M1183 S4-M1184 bar continues to block whole-goal completion.
