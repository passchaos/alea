...
S4-M1179 refreshed status output after updating `latest_validate_local_evidence` in
`rand-status-json` to the post-S4-M1178 validate-local evidence. The passing
...
while the post-S4-M1179 S4-M1180 bar continues to block whole-goal completion.
