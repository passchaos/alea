...
S4-M1197 refreshed status output after exposing the local `rand_distr::Poisson::MAX_LAMBDA` threshold as Alea public constants.
...
$ zig build rand-status-json
  "schema_version": 1,
  "current_conclusion": "S4-M11 runtime branch plus S4-M1124/S4-M1127-S4-M1197 follow-ups closed for current bar",
  "remaining_blocker": "S4-M1198 post-S4-M1197 next product bar",
...
while the post-S4-M1197 S4-M1198 bar continues to block whole-goal completion.
