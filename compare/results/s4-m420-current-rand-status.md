...
S4-M1178 refreshed status output after updating `latest_validate_local_evidence` in
`rand-status-json` to the weighted manifest refresh evidence. The passing
...
while the post-S4-M1178 S4-M1179 bar continues to block whole-goal completion.
