...
S4-M1189 refreshed status output after adding dynamic weighted-tree typed total
diagnostics. The focused weighted validation and retained local comparison
evidence include:
...
while the post-S4-M1189 S4-M1190 bar continues to block whole-goal completion.
