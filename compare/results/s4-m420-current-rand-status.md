...
S4-M1172 refreshed status output after updating `latest_validate_local_evidence` in
`rand-status-json` to the weighted iterator clone/format evidence. The passing
...
while the post-S4-M1172 S4-M1173 bar continues to block whole-goal completion.
