...
| Extra continuous distribution breadth | No direct local `rand_distr` rows because these are Alea product-breadth additions | Added Laplace, Logistic, Rayleigh, HalfNormal, Maxwell, Chi, Erlang, LogLogistic, and Kumaraswamy reusable/direct samplers; local throughput rows are about 139M, 150M, 166M, 413M, 149M, 151M, 159M, 30M, and 38M samples/s | Adopted for feature breadth beyond the local Rust distribution list |
