# S4-M634 Root Item-Accessor Weighted Value Choice Array Empty-Type Prevalidation

## Gap

Root item-accessor weighted repeated-choice fixed-size value array helpers could
proceed toward secure-engine construction for non-zero requests whose value type
is uninhabited. Such requests cannot produce values and should fail before
entropy.

This milestone aligns item-accessor weighted repeated-choice value arrays with
weighted no-replacement value array empty-type validation.
...
S4-M634 is closed for the current bar: root item-accessor weighted repeated-
choice fixed-size value array helpers now prevalidate non-zero uninhabited value
types before secure-engine construction. This is reliability and ergonomics work
