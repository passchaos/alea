# PractRand 64GiB Run: Pcg64

Timestamp: 2026-06-28 CST

PractRand 0.96 was built under `/tmp/practrand/PractRand`. `Pcg64` was tested
through `zig build stream` with `stdin64`, `-tlmin 64GB`, and `-tlmax 64GB`.

## Command

```sh
zig build -Doptimize=ReleaseFast stream -- --engine pcg64 --bytes 68719476736 \
