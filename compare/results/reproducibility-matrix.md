...
| `src/distributions.zig`: `log-normal approximation has stable snapshots` | Current `LogNormalApproxF32` / `logNormalApproxF32*` and `LogNormalExp2F32` / `logNormalExp2F32*` opt-in output mappings for bounded f32 approximations |
