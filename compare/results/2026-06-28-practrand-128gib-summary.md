...
| `pcg64` | one default-seed `unusual`; two alternate-seed runs clean, 320 test results each | `compare/results/2026-06-28-practrand-pcg64-128gib.md`, `compare/results/2026-06-29-practrand-pcg64-third-seed-128gib.md` |
