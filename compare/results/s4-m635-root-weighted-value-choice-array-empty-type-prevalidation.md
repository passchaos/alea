# S4-M635 Root Weighted Value Choice Array Empty-Type Prevalidation

## Gap

Root parallel-weighted repeated-choice fixed-size value array helpers could
...
This milestone aligns parallel-weighted repeated-choice value arrays with
...
- Length mismatch errors still keep their existing precedence.
...
S4-M635 is closed for the current bar: root parallel-weighted repeated-choice
fixed-size value array helpers now prevalidate non-zero uninhabited value types
