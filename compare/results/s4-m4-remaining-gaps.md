...
- SIMD distribution kernels: optimistic repair, correct/same-candidate repair,
  ...
  normal, central-fast inverse-CDF normal, tail-repair inverse-CDF normal,
  invalid central-only inverse-CDF diagnostic, libmvec vector-log exponential,
  and raw-buffer prefetch without a rejected-lane stream policy.
