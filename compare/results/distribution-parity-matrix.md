...
| `Alphanumeric`, `Alphabetic` | Covered by ASCII charsets and `Charset`, including charset count/byte/emptiness/membership/optional-item/probability/probability-iterator size-hint diagnostics |
