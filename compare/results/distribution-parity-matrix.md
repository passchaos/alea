...
| Dirichlet | Covered: `Dirichlet(T)`, allocation and `sampleInto` APIs, including alpha/mean export, variance/covariance lookup, and dimension/total-alpha accessors |
