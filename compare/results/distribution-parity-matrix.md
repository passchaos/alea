...
| `Uniform` integer/float ranges | Covered by `Uniform(T)` and range helpers, including endpoint/inclusivity accessors |
...
| `Bernoulli` | Covered by `Bernoulli`, `chance`, `ratio`, checked variants, and probability accessors |
...
| Rayleigh | Covered: `rayleigh`, `Rayleigh(T)`, including scale accessor |
...
| Dirichlet | Covered: `Dirichlet(T)`, allocation and `sampleInto` APIs, including alpha/dimension accessors |
| Multinomial | Covered: `Multinomial`, including trials/probability accessors |
