...
| `Alphanumeric`, `Alphabetic` | Covered by ASCII charsets and `Charset`, including charset count/byte/emptiness/membership/checked-item/optional-item/probability/probability-iterator size-hint diagnostics |
