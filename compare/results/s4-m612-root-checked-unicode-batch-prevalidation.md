# S4-M612 Root Checked Unicode Scalar Batch Prevalidation

## Gap

Root checked Unicode scalar range batch helpers allocated output buffers before
validating invalid Unicode scalar ranges or invalid code points. Invalid checked
...
This milestone aligns checked Unicode scalar range batch behavior with the root
fill helpers and with earlier checked batch prevalidation work.
...
- Zero-count batches still return empty allocations before validating parameters
  or drawing entropy.
- Invalid Unicode ranges and invalid code points return their checked errors
...
S4-M612 is closed for the current bar: root checked Unicode scalar range batch
