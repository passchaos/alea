...
| Ergonomics | APIs should feel natural in Zig, including allocation-free and comptime-friendly workflows. | `fillSample` gives reusable samplers an allocation-free bulk path, and checked discrete bulk fills reduce boilerplate for fallible high-volume workflows; continue reducing boilerplate where it materially improves ergonomics. |
