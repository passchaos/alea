...
| S4-M1139 next post-S4-M1138 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1138 is closed for the current bar, but the next stricter product improvement has not yet been selected. |
...
status after those delegation fixes, so the next active product bar is S4-M1139.
...
The goal remains active under the new S4-M1139 bar until at least one of these
happens:
