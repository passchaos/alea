...
| S4-M1143 next post-S4-M1142 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1142 is closed for the current bar, but the next stricter product improvement has not yet been selected. |
...
path drift, S4-M1140 refreshes status after that fix, and S4-M1141 extends f64x4 facade standard vector fills, and S4-M1142 extends parameterized f64x4 vector fills, so the next active
product bar is S4-M1143.
...
map drift, S4-M1140 refreshes status again, and S4-M1141 extends f64x4 facade standard vector fills, and S4-M1142 extends parameterized f64x4 vector fills, so the next active product bar
is S4-M1143.

## Required Next Work Before Completion

The goal remains active under the new S4-M1143 bar until at least one of these
happens:
