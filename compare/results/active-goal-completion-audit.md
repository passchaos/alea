...
| S4-M1137 next post-S4-M1136 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1136 is closed for the current bar, but the next stricter product improvement has not yet been selected. |
...
standard-exponential samples, so the next active product bar is S4-M1137.
...
rate-one exponential single samples through standard-exponential samples, so the
next active product bar is S4-M1137.

## Required Next Work Before Completion

The goal remains active under the new S4-M1137 bar until at least one of these
happens:
