...
The goal remains active under the new S4-M1247 bar until at least one of these
happens:
...
- additional directional/spherical distributions (e.g., von Mises-Fisher for
  N-spheres, wrapped normal, wrapped Cauchy) extend the circular/directional
  coverage beyond S1 Von Mises;
