...
| S4-M52 next unblocked product gap | `core-rand-coverage.md`, future audits | Not complete; S4-M11 remains blocked and the next independent product improvement has not yet been selected. |
...
mapping, and S4-M51 adds checked mutable-pointer IndexVec mapping, but they do not resolve S4-M11 or complete the long-term objective.
