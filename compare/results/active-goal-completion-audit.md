...
the next product bar to S4-M1204. Therefore do not call
...
| S4-M1205 next post-S4-M1204 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1204 is closed for the current bar, but the next stricter product improvement has not yet been selected. |
...
The goal remains active under the new S4-M1205 bar until at least one of these
happens:
...
S4-M1205 remains active after S4-M1204 repairs vectorbench status drift.
