...
| S4-M1210 next post-S4-M1209 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1209 is closed for the current bar, but the next stricter product improvement has not yet been selected. |
...
The goal remains active under the new S4-M1210 bar until at least one of these
happens:
...
S4-M1210 remains active after S4-M1209 refreshes full validation.
