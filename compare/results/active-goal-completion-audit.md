...
the next product bar to S4-M1206. Therefore do not call
...
| S4-M1204 vectorbench status drift repair | `compare/results/s4-m1205-post-s4-m1204-validate-local.md` | Closed for the current bar: S4-M1202/S4-M1203 audit/status mappings now point to their own evidence files and roadmapcheck guards the chain. |
...
| S4-M1206 next post-S4-M1205 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1205 is closed for the current bar, but the next stricter product improvement has not yet been selected. |
...
The goal remains active under the new S4-M1206 bar until at least one of these
happens:
...
S4-M1204 is closed after repairing vectorbench status drift in `compare/results/s4-m1205-post-s4-m1204-validate-local.md`.

S4-M1205 is closed after refreshing validate-local evidence in `compare/results/s4-m1205-post-s4-m1204-validate-local.md`.

S4-M1206 remains active after S4-M1205 refreshes validate-local evidence.
