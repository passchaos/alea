...
the next product bar to S4-M1227 after S4-M1226 refactored vectorized float fill lane stores and reduced lane-width drift risk without changing the S4-M1223 grid contract. Therefore do not call
...
The goal remains active under the new S4-M1227 bar until at least one of these
happens:
...
S4-M1227 remains active after S4-M1226 raises the next correctness/performance/product bar.
