...
the next product bar to S4-M1180. Therefore do not call
...
| S4-M1180 next post-S4-M1179 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1179 is closed for the current bar, but the next stricter product improvement has not yet been selected. |
