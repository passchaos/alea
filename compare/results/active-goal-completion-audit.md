...
the next product bar to S4-M1238 after S4-M1237 aligned direct-source byte-helper fallback behavior without changing direct-engine raw alias contracts. Therefore do not call
...
| S4-M1238 next post-S4-M1237 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1237 closes the direct-source byte-helper fallback hardening, while exact/default dense SIMD, broader runtime evidence, longer validation, further semantics-preserving performance work, and future newly discovered gaps remain open tracks. |
...
The goal remains active under the new S4-M1238 bar until at least one of these
happens:
