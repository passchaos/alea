...
the next product bar to S4-M1225 after S4-M1224 recovered f64 StandardUniform throughput without changing the S4-M1223 grid contract. Therefore do not call
...
| S4-M1225 next post-S4-M1224 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1224 closes correctness-preserving f64 StandardUniform throughput recovery, while exact/default dense SIMD, broader runtime evidence, longer validation, further semantics-preserving performance work, and future newly discovered gaps remain open tracks. |
...
The goal remains active under the new S4-M1225 bar until at least one of these
happens:
