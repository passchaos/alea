...
| S4-M1193 next post-S4-M1192 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1192 is closed for the current bar, but the next stricter product improvement has not yet been selected. |
...
The goal remains active under the new S4-M1193 bar until at least one of these
happens:
