...
the next product bar to S4-M1226 after S4-M1225 improved the ordinary f64 uniform low-bit/vector8 hot path without changing the S4-M1223 grid contract. Therefore do not call
...
| S4-M1226 next post-S4-M1225 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1225 closes another semantics-preserving f64 uniform throughput step, while exact/default dense SIMD, broader runtime evidence, longer validation, further semantics-preserving performance work, and future newly discovered gaps remain open tracks. |
...
The goal remains active under the new S4-M1226 bar until at least one of these
happens:
