...
the next product bar to S4-M1240 after S4-M1239 aligned seed/fork native-u64 fallback behavior without changing direct-engine raw alias contracts. Therefore do not call
...
| S4-M1240 next post-S4-M1239 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1239 closes the seed/fork native-u64 fallback hardening, while exact/default dense SIMD, broader runtime evidence, longer validation, further semantics-preserving performance work, and future newly discovered gaps remain open tracks. |
...
The goal remains active under the new S4-M1240 bar until at least one of these
happens:
