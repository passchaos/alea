...
the next product bar to S4-M1231 after S4-M1230 refactored the remaining rng normal affine lane-store helper without changing normal output contracts. Therefore do not call
...
| S4-M1231 next post-S4-M1230 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1230 closes the remaining core normal-affine lane-store refactor, while exact/default dense SIMD, broader runtime evidence, longer validation, further semantics-preserving performance work, and future newly discovered gaps remain open tracks. |
...
The goal remains active under the new S4-M1231 bar until at least one of these
happens:
