...
the next product bar to S4-M1221. Therefore do not call
...
| S4-M1221 next post-S4-M1220 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1220 raises the multivariate feature bar, but exact/default dense SIMD, broader runtime evidence, longer validation, and future newly discovered gaps remain open tracks. |
...
The goal remains active under the new S4-M1221 bar until at least one of these
happens:
