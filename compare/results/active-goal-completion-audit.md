...
| S4-M1138 next post-S4-M1137 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1137 is closed for the current bar, but the next stricter product improvement has not yet been selected. |
...
normal single samples through standard-normal samples, so the next active product
bar is S4-M1138.
...
The goal remains active under the new S4-M1138 bar until at least one of these
happens:
