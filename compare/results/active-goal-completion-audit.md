...
| S4-M1130 next post-S4-M1129 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1129 is closed for the current bar, but the next stricter product improvement has not yet been selected. |
...
specialization, and S4-M1129 refreshes status after those direct-fill closures,
so the next active product bar is S4-M1130.
...
refreshes status after those closures, so the next active product bar is S4-M1130.

## Required Next Work Before Completion

The goal remains active under the new S4-M1130 bar until at least one of these
happens:
