...
the next product bar to S4-M1236 after S4-M1235 aligned fallible direct-source raw-u32 fallback behavior without changing direct-engine raw alias contracts. Therefore do not call
...
| S4-M1236 next post-S4-M1235 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1235 closes the direct-source fallible raw-u32 fallback hardening, while exact/default dense SIMD, broader runtime evidence, longer validation, further semantics-preserving performance work, and future newly discovered gaps remain open tracks. |
...
The goal remains active under the new S4-M1236 bar until at least one of these
happens:
