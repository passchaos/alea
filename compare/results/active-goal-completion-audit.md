...
the next product bar to S4-M1134. Therefore do not call
...
| S4-M1134 next post-S4-M1133 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1133 is closed for the current bar, but the next stricter product improvement has not yet been selected. |
...
routes rate-one vector exponential fills through standard-exponential fills, so
the next active product bar is S4-M1134.
...
The goal remains active under the new S4-M1134 bar until at least one of these
happens:
