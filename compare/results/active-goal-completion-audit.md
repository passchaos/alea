...
| S4-M1202 next post-S4-M1201 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1201 is closed for the current bar, but the next stricter product improvement has not yet been selected. |
...
The goal remains active under the new S4-M1202 bar until at least one of these
happens:
...
S4-M1202 remains active after S4-M1201 refreshes f32x8 vectorbench evidence.
