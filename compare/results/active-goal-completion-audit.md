...
the next product bar to S4-M1230 after S4-M1229 completed the vector sampler lane-count sweep without changing distribution output contracts. Therefore do not call
...
The goal remains active under the new S4-M1230 bar until at least one of these
happens:
...
S4-M1230 remains active after S4-M1229 raises the next correctness/performance/product bar.
