...
| S4-M1202 f64x4 vectorbench refresh | `compare/results/s4-m1203-parameterized-vectorbench-refresh.md` | Closed for the current bar: focused f64x4 standard normal/exponential vectorbench rows still find no exact/default production replacement for scalar lane-fill. |
...
| S4-M1204 next post-S4-M1203 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1203 is closed for the current bar, but the next stricter product improvement has not yet been selected. |
...
The goal remains active under the new S4-M1204 bar until at least one of these
happens:
