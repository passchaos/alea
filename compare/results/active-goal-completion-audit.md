...
the next product bar to S4-M1172. Therefore do not call
...
| S4-M1172 next post-S4-M1171 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1171 is closed for the current bar, but the next stricter product improvement has not yet been selected. |
...
The goal remains active under the new S4-M1172 bar until at least one of these
happens:
