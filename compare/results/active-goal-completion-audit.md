...
the next product bar to S4-M1235 after S4-M1234 hardened root alphanumeric string preallocation before secure entropy without changing string output contracts. Therefore do not call
...
| S4-M1235 next post-S4-M1234 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1234 closes the root string preallocation hardening, while exact/default dense SIMD, broader runtime evidence, longer validation, further semantics-preserving performance work, and future newly discovered gaps remain open tracks. |
...
The goal remains active under the new S4-M1235 bar until at least one of these
happens:
