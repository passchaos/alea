...
the next product bar to S4-M1232 after S4-M1231 hardened rng byte-fill / reader refill correctness without changing byte-stream contracts. Therefore do not call
...
| S4-M1232 next post-S4-M1231 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1231 closes the rng byte-stream hardening follow-up, while exact/default dense SIMD, broader runtime evidence, longer validation, further semantics-preserving performance work, and future newly discovered gaps remain open tracks. |
...
The goal remains active under the new S4-M1232 bar until at least one of these
happens:
