...
| S4-M1131 next post-S4-M1130 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1130 is closed for the current bar, but the next stricter product improvement has not yet been selected. |
...
refreshes full validate-all evidence, so the next active product bar is S4-M1131.
...
evidence, so the next active product bar is S4-M1131.

## Required Next Work Before Completion

The goal remains active under the new S4-M1131 bar until at least one of these
happens:
