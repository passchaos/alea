...
the next product bar to S4-M1241 after S4-M1240 aligned `Rng.init` raw-alias source fallback behavior without changing direct-engine raw alias contracts. Therefore do not call
...
| S4-M1241 next post-S4-M1240 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1240 closes the facade-constructor raw-alias hardening, while exact/default dense SIMD, broader runtime evidence, longer validation, further semantics-preserving performance work, and future newly discovered gaps remain open tracks. |
...
The goal remains active under the new S4-M1241 bar until at least one of these
happens:
