...
| S4-M1190 next post-S4-M1189 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1189 is closed for the current bar, but the next stricter product improvement has not yet been selected. |
...
The goal remains active under the new S4-M1190 bar until at least one of these
happens:
