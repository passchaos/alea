...
the next product bar to S4-M1222. Therefore do not call
...
| S4-M1222 next post-S4-M1221 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1221 closes the first multivariate-normal performance follow-up, while exact/default dense SIMD, broader runtime evidence, longer validation, and future newly discovered gaps remain open tracks. |
...
The goal remains active under the new S4-M1222 bar until at least one of these
happens:
