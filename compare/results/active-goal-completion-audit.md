...
| S4-M28 next unblocked product gap | `core-rand-coverage.md`, future audits | Not complete; S4-M11 remains blocked and the next independent product improvement has not yet been selected. |
...
guidance, S4-M26 adds advanced-continuous adoption guidance, and S4-M27 adds
rank-distribution adoption guidance, but they do not resolve S4-M11 or complete
