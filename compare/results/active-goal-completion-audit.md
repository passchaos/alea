...
| S4-M37 next unblocked product gap | `core-rand-coverage.md`, future audits | Not complete; S4-M11 remains blocked and the next independent product improvement has not yet been selected. |
...
sequence sampling, S4-M34 adds one-shot weighted item/pointer choice, and S4-M35 adds caller-owned reservoir sampling, and S4-M36 adds caller-owned
iterator reservoir sampling, but they do not resolve S4-M11 or complete the
long-term objective.
