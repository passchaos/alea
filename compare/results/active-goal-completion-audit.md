...
the next product bar to S4-M1237 after S4-M1236 aligned direct-source native-u64 fallback behavior without changing direct-engine raw alias contracts. Therefore do not call
...
| S4-M1237 next post-S4-M1236 product bar | `core-rand-coverage.md`, future audits | Not complete; S4-M1236 closes the direct-source native-u64 fallback hardening, while exact/default dense SIMD, broader runtime evidence, longer validation, further semantics-preserving performance work, and future newly discovered gaps remain open tracks. |
...
The goal remains active under the new S4-M1237 bar until at least one of these
happens:
...
S4-M1237 remains active after S4-M1236 raises the next correctness/performance/product bar.
