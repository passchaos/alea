...
`rand_distr::Gamma::new` and `ChiSquared::new`, the documented direct
...
S4-M1124/S4-M1127-S4-M1147 follow-ups are closed for the current bar while
S4-M1148 is the next post-S4-M1147 product bar. This is tooling validation
