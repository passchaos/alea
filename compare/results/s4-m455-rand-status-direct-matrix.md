...
`rand_distr::Poisson`, the documented direct argument forms for
...
S4-M1124/S4-M1127-S4-M1155 follow-ups are closed for the current bar while
S4-M1156 is the next post-S4-M1155 product bar. This is tooling validation
