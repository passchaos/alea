...
`rand_distr::multi::Dirichlet`, the documented direct argument forms for
...
S4-M1124/S4-M1127-S4-M1161 follow-ups are closed for the current bar while
S4-M1162 is the next post-S4-M1161 product bar. This is tooling validation
