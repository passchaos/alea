...
`rand_distr::Hypergeometric`, the documented direct argument forms for
...
S4-M1124/S4-M1127-S4-M1160 follow-ups are closed for the current bar while
S4-M1161 is the next post-S4-M1160 product bar. This is tooling validation
