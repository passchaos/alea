...
`rand_distr::Pert`, the documented direct argument forms for
...
S4-M1124/S4-M1127-S4-M1154 follow-ups are closed for the current bar while
S4-M1155 is the next post-S4-M1154 product bar. This is tooling validation
