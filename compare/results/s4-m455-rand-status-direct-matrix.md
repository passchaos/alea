...
After S4-M1215 refreshed local `rand` / `rand_distr` comparison evidence, the
...
S4-M1124/S4-M1127-S4-M1215 follow-ups are closed for the current bar while
S4-M1216 is the next post-S4-M1215 product bar. This is tooling validation
