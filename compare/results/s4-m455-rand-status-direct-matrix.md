...
`rand_distr::Triangular::new`, the documented direct argument forms for
...
S4-M1124/S4-M1127-S4-M1153 follow-ups are closed for the current bar while
S4-M1154 is the next post-S4-M1153 product bar. This is tooling validation
