...
| `WeightedIndex`, `WeightedIndexIter`, `Weight`, `weighted::WeightedIndex`, `weighted::Error`, `weight`, `update_weights`, `weights`, `total_weight` | Covered by `WeightedIndex`, `AliasTable`, `distributions.weighted.WeightedIndex`, optional single `weight`, `weights` / `weightIter`, `updateWeights`, `totalWeight`, weighted error aliases/variants, weighted error message helpers, root/prelude weighted error aliases, and weighted iterator clone/format helpers; Rust `Weight` trait bounds are implementation machinery; see S4-M191, S4-M192, S4-M221, S4-M265, S4-M271, S4-M281, S4-M284, S4-M1172, S4-M1174, and S4-M1176. |
