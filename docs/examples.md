...
| `zig build run-sequence-sampling` | `examples/sequence_sampling.zig` | Index sampling, fixed-size item arrays, item subsets, partial shuffle, reservoir sampling, reusable choices, and streaming iterator helpers. |
