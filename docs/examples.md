...
| --- | --- | --- |
| `zig build run-basic` | `examples/basic.zig` | A broad first tour: engines, `Rng`, owned byte/value/sample/scalar-and-vector-probability/scalar-and-vector normal/exponential batches, distributions, strings, index and const-pointer choice, sequence helpers, and child streams. |
