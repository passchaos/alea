...
- Collections: `chooseMultiple`, `chooseMultipleFrom`,
  ...
  `SampledValueIterator.remaining`, `SampledValueIterator.fill`,
  ...
  `SampledPtrIterator.remaining`, `SampledPtrIterator.fill`,
  ...
  `SampledMutPtrIterator.remaining`, `SampledMutPtrIterator.fill`,
