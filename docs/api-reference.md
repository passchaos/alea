...
- Enums and collections: `enumValue`, `enumValueFrom`, `enumValueChecked`,
  ...
  `chooseIndexU32CheckedFrom`, `fillChooseIndexU32`, `fillChooseIndexU32From`,
  ...
  `chooseConstPtrCheckedFrom`, `fillChooseConstPtr`,
  ...
  `choosePtrChecked`, `choosePtrCheckedFrom`, `fillChoosePtr`,
  ...
  `weightedIndexU32BatchCheckedFrom`, `chooseWeighted`, `chooseWeightedFrom`,
  ...
  `chooseWeightedBatchCheckedFrom`, `chooseWeightedConstPtr`,
  ...
  `chooseWeightedConstPtrByCheckedFrom`, `fillChooseWeightedConstPtr`,
  ...
  `chooseWeightedConstPtrBatchCheckedFrom`, `chooseWeightedPtr`,
  ...
  `chooseWeightedPtrByCheckedFrom`, `fillChooseWeightedPtr`,
  ...
  `chooseWeightedPtrBatchCheckedFrom`,
...
- Index vectors: `IndexVec.len`, `IndexVec.isEmpty`, `IndexVec.at`,
  ...
  `IndexVec.toOwnedU32Slice`, `IndexVec.values`, `IndexVec.valuesChecked`,
  ...
  `MutPtrIterator.remaining`, `IndexVec.deinit`
...
- Reusable samplers: `Choice(T)`, `chooseIter`, `chooseIterFrom`,
  ...
  `Choice.ptrsFrom`, `Choice.values`, `Choice.valuesFrom`, `Choice.fillIndices`,
  `Choice.fillIndicesFrom`, `Choice.fillIndicesU32`,
  `Choice.fillIndicesU32From`, `Choice.indices`, `Choice.indicesFrom`,
  `Choice.indicesU32`, `Choice.indicesU32From`, `Choice.iter`,
  `Choice.iterFrom`,
  `WeightedChoice.init`, `WeightedChoice.initBy`, `WeightedChoice.deinit`, `WeightedChoice.len`,
  ...
  `WeightedChoice.update`, `WeightedChoice.updateBy`, `WeightedChoice.sample`,
...
- Weighted one-shot/index batches: `weightedIndex`, `weightedIndexFrom`,
  ...
  `chooseWeightedBy`, `chooseWeightedByFrom`, `chooseWeightedByChecked`,
  `chooseWeightedByCheckedFrom`, `fillChooseWeighted`, `fillChooseWeightedFrom`,
  `fillChooseWeightedChecked`, `fillChooseWeightedCheckedFrom`,
...
- Weighted one-shot slices: `chooseWeighted`, `chooseWeightedFrom`,
  ...
  `chooseWeightedPtrCheckedFrom`, `chooseWeightedPtrBy`,
  `chooseWeightedPtrByFrom`, `chooseWeightedPtrByChecked`,
  `chooseWeightedPtrByCheckedFrom`
- Weighted no-replacement: `sampleWeightedIndices`,
  ...
  `sampleWeightedIndexVecCheckedFrom`, `sampleWeightedIndicesBy`,
