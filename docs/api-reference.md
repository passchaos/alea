...
- System-entropy helpers: `makeRng`, `random`, `randomValue`,
  ...
  `chooseWeightedValueArrayByIndexChecked`, `fillChooseWeightedConstPtrByIndex`,
  ...
  `chooseWeightedConstPtrArrayByIndexChecked`, `fillChooseWeightedPtrByIndex`,
  `fillChooseWeightedPtrByIndexChecked`, `chooseWeightedPtrBatchByIndex`,
