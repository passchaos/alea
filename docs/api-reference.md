...
- Bytes/fill: `bytes`, `bytesAlloc`, `bytesAllocFrom`, `fill` and `fillFrom` for scalar and vector slices,
  ...
  `fillNormal`, `normalBatch`, `normalBatchFrom`, `normalBatchChecked`,
  `normalBatchCheckedFrom`, `fillNormalChecked`, `fillNormalCheckedFrom`,
  `fillExponential`, `exponentialBatch`, `exponentialBatchFrom`,
  `exponentialBatchChecked`, `exponentialBatchCheckedFrom`,
...
- Enums and collections: `enumValue`, `enumValueFrom`, `enumValueChecked`,
  ...
  `chooseIndexU32CheckedFrom`, `chooseConstPtr`,
