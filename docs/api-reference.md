...
- `triangular`, `triangularFrom`, `triangularChecked`,
  ...
  `fillCauchy`, `fillCauchyFrom`, `laplace`, `laplaceFrom`,
  `laplaceChecked`, `laplaceCheckedFrom`, `fillLaplace`,
  `fillLaplaceFrom`, `logistic`, `logisticFrom`, `logisticChecked`,
  `logisticCheckedFrom`, `fillLogistic`,
