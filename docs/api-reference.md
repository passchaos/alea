...
- Enums and collections: `enumValue`, `enumValueFrom`, `enumValueChecked`,
  ...
  `chooseWeightedConstPtrCheckedFrom`, `fillChooseWeightedConstPtr`,
  ...
  `chooseWeightedPtrCheckedFrom`, `fillChooseWeightedPtr`,
...
- Weighted one-shot/index batches: `weightedIndex`, `weightedIndexFrom`,
  ...
  `fillChooseWeighted`, `fillChooseWeightedFrom`,
