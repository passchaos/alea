...
- Collections: `chooseMultiple`, `chooseMultipleFrom`,
  ...
  `SampledValueIterator.remaining`, `SampledValueIterator.deinit`,
  ...
  `SampledPtrIterator.remaining`, `SampledPtrIterator.deinit`,
  ...
  `SampledMutPtrIterator.remaining`, `SampledMutPtrIterator.deinit`, `chooseMultipleInto`,
