...
- Collections: `chooseMultiple`, `chooseMultipleFrom`,
  ...
  `sampleMutPtrsCheckedFrom`, `chooseMultipleInto`,
...
- Reusable samplers: `Choice(T)`, `chooseIter`, `chooseIterFrom`,
  ...
  `Choice.indexArrayU32CheckedFrom`, `Choice.iter`, `Choice.iterFrom`,
  `WeightedChoice.init`, `WeightedChoice.initBy`, `WeightedChoice.initByIndex`, `WeightedChoice.deinit`, `WeightedChoice.len`,
  ...
  `WeightedChoice.update`, `WeightedChoice.updateBy`, `WeightedChoice.updateByIndex`, `WeightedChoice.sample`,
...
- Weighted one-shot/index batches: `weightedIndex`, `weightedIndexFrom`,
  ...
  `weightedIndexByCheckedFrom`, `weightedIndexU32By`,
  `weightedIndexU32ByFrom`, `weightedIndexU32ByChecked`,
  `weightedIndexU32ByCheckedFrom`, `fillWeightedIndexBy`,
  ...
  `chooseWeightedBy`, `chooseWeightedByFrom`, `chooseWeightedByChecked`,
  `chooseWeightedByCheckedFrom`, `fillChooseWeightedBy`,
  ...
  `chooseWeightedConstPtrCheckedFrom`, `chooseWeightedConstPtrBy`,
  `chooseWeightedConstPtrByFrom`, `chooseWeightedConstPtrByChecked`,
  `chooseWeightedConstPtrByCheckedFrom`, `fillChooseWeightedConstPtrBy`,
  ...
  `chooseWeightedPtrCheckedFrom`, `chooseWeightedPtrBy`,
  `chooseWeightedPtrByFrom`, `chooseWeightedPtrByChecked`,
  `chooseWeightedPtrByCheckedFrom`, `fillChooseWeightedPtrBy`,
