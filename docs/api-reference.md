...
- System-entropy helpers: `makeRng`, `random`, `randomValue`,
  ...
  `chooseIndexBatchChecked`, `chooseIndexU32`, `chooseIndexU32Checked`,
  `fillChooseIndexU32`, `fillChooseIndexU32Checked`, `chooseIndexU32Batch`,
  `chooseIndexU32BatchChecked`, `choose`, `chooseChecked`, `fillChoose`,
  `fillChooseChecked`, `chooseBatch`, `chooseBatchChecked`, `shuffle`,
