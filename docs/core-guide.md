...
`Charset.allocFrom`, `Charset.probability` / `probabilityAt`, `charFrom`, `stringFrom`, `unicodeScalarFrom`,
...
ASCII charsets, custom `Charset` probability diagnostics, allocation-returning strings,
